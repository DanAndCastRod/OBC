...
| Autor                                         | Año  | Título                                                                                                        | Técnica de solución                          | Función objetivo                                                    | Aplicaciones                                                    |
|-----------------------------------------------|------|---------------------------------------------------------------------------------------------------------------|-----------------------------------------------|---------------------------------------------------------------------|-----------------------------------------------------------------|
| Pisuchpen & Ongkunaruk                        | 2016 | Simulation for production line balancing of a large-sized frozen chicken manufacturer                         | Simulación discreta + método ECRS             | Reducir tiempo de ciclo y número de operarios; mejorar utilización  | Planta de procesamiento de pollo congelado                      |
| Özceylan et al.                               | 2019 | Disassembly line balancing problem: a review of the state of the art and future directions                    | Revisión bibliográfica                        | Sintetizar el estado del arte; identificar tendencias               | General (revisión de DLBP)                                       |
| Piewthongngam et al.                          | 2019 | Disassembly scheduling for the meat processing industry with product perishability                           | Programación matemática de scheduling         | Minimizar pérdidas por perecibilidad y satisfacer demanda          | Industria de procesamiento de carne porcina                      |
| Akpınar, Ilgın & Aktaş                        | 2021 | Disassembly Line Balancing by Using Simulation Optimization                                                    | Simulación–optimización (metaheurística)      | Minimizar desequilibrio de línea (tiempos ociosos) bajo incertidumbre | Instancias genéricas de DLBP; electrónica y automotriz           |
| Wang et al.                                   | 2022 | Modeling and Balancing for Disassembly Lines Considering Workers With Different Efficiencies                  | Algoritmo de polinización de flores (metaheurística) | Minimizar número de estaciones y tiempos improductivos considerando heterogeneidad de operarios | Líneas de desensamble con operarios de diferentes eficiencias   |
| Paprocka & Skołud                             | 2022 | A Predictive Approach for Disassembly Line Balancing Problems                                                 | Aprendizaje automático + optimización         | Mejorar equilibrio de carga mediante estimación predictiva de tiempos | Líneas de desensamble con variabilidad en tiempos de operación   |
