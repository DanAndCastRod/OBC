...
PARAMETROS_SENSIBILIDAD = {
    ...
    'Hybrid': {
        'aplicar_ts_cada': [10, 15, 20, 24, 30],
        'iter_ts_por_individuo': [10, 20, 28, 35, 40],
    }
}
...
N_REPLICAS = 30
SEMILLA_BASE = 42
MAX_GENERACIONES = 100  # Generaciones completas para resultados reales
